...
function init_gear_sets()
    ...
    sets.precast.Step = {
        ...
        ear1={name="Mache Earring +1", bag="wardrobe3"},
        ear2={name="Mache Earring +1", bag="wardrobe4"},
    ...
    sets.precast.Flourish1['Violent Flourish'] = {
        ...
        ring1={name="Stikini ring", bag="wardrobe4"},
        ring2="Mummu ring",
        waist="Eschan Stone",
        back=gear.DNC_TP_Cape,
        } -- Magic Accuracy
